...
class Pizza extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pizza', createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'toppings')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inches', $pb.PbFieldType.O3)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cheese')
  ...
  @$pb.TagNumber(1)
  $core.List<$core.String> get toppings => $_getList(0);

  @$pb.TagNumber(2)
  $core.int get inches => $_getIZ(1);
  @$pb.TagNumber(2)
  set inches($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasInches() => $_has(1);
  @$pb.TagNumber(2)
  void clearInches() => clearField(2);

  @$pb.TagNumber(3)
  $core.bool get cheese => $_getBF(2);
  @$pb.TagNumber(3)
  set cheese($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
...
class OrderConfirmation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OrderConfirmation', createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'estimatedDelivery')
    ..hasRequiredFields = false
  ;

  OrderConfirmation._() : super();
  factory OrderConfirmation({
    $fixnum.Int64? estimatedDelivery,
  }) {
    final _result = create();
    if (estimatedDelivery != null) {
      _result.estimatedDelivery = estimatedDelivery;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OrderConfirmation copyWith(void Function(OrderConfirmation) updates) => super.copyWith((message) => updates(message as OrderConfirmation)) as OrderConfirmation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $fixnum.Int64 get estimatedDelivery => $_getI64(0);
  @$pb.TagNumber(1)
  set estimatedDelivery($fixnum.Int64 v) { $_setInt64(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasEstimatedDelivery() => $_has(0);
  @$pb.TagNumber(1)
  void clearEstimatedDelivery() => clearField(1);
}
